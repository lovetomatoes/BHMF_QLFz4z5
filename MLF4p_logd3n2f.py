...
t_life, logd_fit, l_cut, a = 30, -2, 1., 0.1 # f_seed = .01, log_prob= -8.14
t_life, logd_fit, l_cut, a = 35, -2, 1., -0.05 # f_seed = .1, log_prob= -14.76
t_life, logd_fit, l_cut, a = 40, -2, .9, -.2 # f_seed = 1., log_prob= -10.33
...
prex='../4p/3n2f_logd_4pr8_f{1:d}'.format(n_base,int(abs(np.log10(f_seed))))
# LFbin, LFcur, MF1e8 
